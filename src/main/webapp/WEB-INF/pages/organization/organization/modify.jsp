...
jQuery().ready(function() {
	...
	jQuery("#user").validate({
		...
		submitHandler : function(form) {
			...
			jQuery.ajax({
				url : _path + 'organizationAction/modify.do',
				type : "post",
				data : user,
				async : false,
				success : function(data) {
...
<body style="min-width: 540px; overflow: auto; overflow: hidden">
	<div style="display:;" class="inputTable">
		<form id="user" action="" method="post">
			...
			<input type="hidden" name="agencyNo" value="${a.agencyNo}" />
			<table class="inputTable_liebiao inputTable_validate clear">
				<tbody>
					<tr>
						<th>部门编号:</th>
						<td><input type="text" value="${a.agencyNo}"
							class="formText" name="agency_no" disabled="disabled" maxlength="10"/></td>
